...
Mobird.TouchClick = Mobird.requireModule('modules/touchclick');
Mobird.initializeTouchEvents = function(layer, options) {
  Mobird.TouchClick.attach(layer || document.body, options || {});
};