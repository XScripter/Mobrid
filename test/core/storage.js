...
describe('Storage', function() {
  ...
  if (Mobird.Storage.isAvailable(store_type)) {
    ...
    describe(store_type, function() {
      ...
      beforeEach(function() {
        ...
        store = new Mobird.Storage(store_attributes);

        other_store = new Mobird.Storage({
          element: '#main',
      ...
      it('stores in global space accessible by name', function() {
        store.set('foo', 'bar');
        var new_store = new Mobird.Storage(store_attributes);
      ...
      it('fires a specific key event on set', function(done) {
        Mobird.$('#main').bind('set-test_store-foo', function(e, data) {
          Mobird.$('#main').unbind('set-test_store-foo');
      ...
      it('fires store event on set', function(done) {
        Mobird.$('#main').bind('set-test_store', function(e, data) {
          Mobird.$('#main').unbind('set-test_store');
  ...
  if (Mobird.Storage.isAvailable(store_type)) {
    ...
    describe(store_type, function() {
      ...
      it('checks if a key exists', function() {
        ...
        console.log('========1' + store.exists('foo'));

        expect(store.exists('foo')).to.be(false);
        store.set('foo', 'bar');

        console.log('========2' + store.exists('foo'));
        expect(store.exists('foo')).to.be(true);

        console.log('========3' + other_store.exists('foo'));
        expect(other_store.exists('foo')).to.be(false);
      });
