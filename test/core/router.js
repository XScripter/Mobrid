...
describe("Mobird.Router suite.", function() {
  it("Check that Mobird.Router exists and is a Function", function() {
    Mobird.Router.should.be.ok;
  });
  ...
  describe('Testing simple route', function() {
    ...
    describe("Once router is instantiated,", function() {
      it('it is defined', function() {
        router.should.be.an.instanceOf(Mobird.Router)
      });
      it("it has ['redirect','setLocation','addRoute','play','pause'] methods", function(done) {
        ['redirect', 'addRoute', 'play', 'pause', 'setLocation'].forEach(function(prop) {
    ...
    describe('run and destroy', function() {
      ...
      beforeEach(function(done) {
        ...
        router
          ...
          .addRoute('#/path/third', function(req, next) {
            third.solve('error');
          });
