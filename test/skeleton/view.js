(function() {
  ...
  test("$el", 3, function() {
    ...
    ok(Mobird.$.query.isQ(view.$el));

    strictEqual(view.$el[0], view.el);
  });

  test("initialize", 1, function() {
    var View = Mobird.View.extend({
      initialize: function() {
        this.one = 1;
      }
    });
  ...
  test("delegateEvents", 6, function() {
    ...
    var view = new Mobird.View({el: '#testElement'});
  ...
  test("delegateEvents allows functions for callbacks", 3, function() {
    var view = new Mobird.View({el: '<p></p>'});
    view.counter = 0;
  ...
  test("undelegate", 1, function() {
    view = new Mobird.View({el: '#testElement'});
  ...
  test("#1048 - setElement uses provided object.", 2, function() {
    ...
    var view = new Mobird.View({el: $el});
    ok(view.$el === $el);
  ...
  test("views stopListening", 0, function() {
    ...
    var view = new View({
      model: new Mobird.Model,
      collection: new Mobird.Collection
    });
